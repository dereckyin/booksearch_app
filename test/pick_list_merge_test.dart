...
void main() {
  ...
  group('buildMergePlan', () {
    PickListMain m(String sd) => PickListMain(sdNo: sd);

    test('suffix by item count desc, merge sort by rk_id', () {
      final small = m('B');
      final large = m('A');
  ...
  group('mergeCardMainsOrdered', () {
    test('by ttl_must_qty desc then sd_no', () {
